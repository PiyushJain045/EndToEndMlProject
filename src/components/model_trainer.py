    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            X_train,y_train,X_test,y_test = (
                train_array[:,:-1], # Extracts all rows and column except last column --> TRAIN
                train_array[:,-1], # Extracts all rows and ONLY last column --> TRAIN
                test_array[:,:-1], # Extracts all rows and column except last column --> TEST
                test_array[:,-1], # Extracts all rows and ONLY last column --> TEST
            )

            #2) Preparing 'model name' + 'model object' dictionary
